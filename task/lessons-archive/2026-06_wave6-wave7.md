...
# Lessons archive — Wave 6 / Wave 7 (2026-06-11 → 2026-06-13)

Verbatim entries moved out of [../lessons.md](../lessons.md) by the
[compaction/SKILL.md](../../.agents/skills/compaction/SKILL.md) pass on 2026-06-13 (pass 5 — Wave-6/Wave-7
compaction). **Not read by default** — grep here on demand. Covers the Wave-4 F2 variant-shredding
overlay, the Wave-5 U1/Y2/Y3 view + theta/Alpha-sketch arcs, the Wave-6 O1/O2/O3 core burn-down,
the I1/I2/I3 + I-LANE interop sweep, and the Wave-7 R1/R2/R3 SQL-CAS + partition-stats interop
increments — all increment-scoped narratives whose work has landed. Nothing distilled into a rule;
these are preserved verbatim for provenance.
