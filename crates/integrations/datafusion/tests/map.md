...
| `target_file_size.rs` | F-TARGET-FILE-SIZE-1: oracle-shape INSERT (200k rows over 4 streams) writes 20 files within ±25% of the Spark file count and max size at target 262144; 1 MiB and default targets keep one file per stream; created tables carry the stamped zstd codec (row R172, row R173) |
