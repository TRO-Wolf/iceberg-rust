...
//! shredding (including `ShreddedObject`'s partial-shred overlay — Wave-4 F2), and file-level
//! variant data I/O + Java↔Rust interop (blocked at the pinned parquet 57.1 / arrow-rs 57.1
//! crates, which expose no variant type; the Arrow conversion errors loudly) beyond the
//! 1.10.0-generated byte pins in `tests.rs`.
