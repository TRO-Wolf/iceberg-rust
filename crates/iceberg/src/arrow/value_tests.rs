...
fn test_arrow_struct_to_iceberg_struct() {
    ...
    let timestamp_micro_array =
        TimestampMicrosecondArray::from(vec![Some(1622548800000000), Some(1622635200000000), None]);
    ...
    let binary_array = BinaryArray::from(vec![Some(b"abc".as_ref()), Some(b"def".as_ref()), None]);
...
fn test_find_field_by_id() {
    ...
    let nested_struct_array =
        Arc::new(StructArray::from(vec![
            ...
            (
                Arc::new(
                    Field::new("field_b", DataType::Utf8, true).with_metadata(HashMap::from([(
                        PARQUET_FIELD_ID_META_KEY.to_string(),
                        "2".to_string(),
                    )])),
                ),
    ...
    let struct_array = Arc::new(StructArray::from(vec![
            ...
            Arc::new(
                Field::new(
                    ...
                    DataType::Struct(Fields::from(vec![
                        Field::new("field_a", DataType::Int32, true).with_metadata(HashMap::from(
        ...
        (
            Arc::new(
                Field::new("field_c", DataType::Int32, true).with_metadata(HashMap::from([(
                    PARQUET_FIELD_ID_META_KEY.to_string(),
                    "4".to_string(),
                )])),
            ),
...
fn test_complex_nested() {
        ...
        Arc::new(NestedField::required(
            ...
            Type::List(ListType::new(Arc::new(NestedField::required(
                ...
                Type::Map(MapType::new(
                    NestedField::optional(6, "keys", Type::Primitive(PrimitiveType::Int)).into(),
                    NestedField::optional(7, "values", Type::Primitive(PrimitiveType::Int)).into(),
                )),
            )))),
        )),
        Arc::new(NestedField::required(
    ...
    let struct_array = {
        ...
        let mut top_struct_builder = {
            ...
            let a_type = DataType::List(Arc::new(Field::new("item", a_struct_type.clone(), true)));
            ...
            let b_type = DataType::List(Arc::new(Field::new("item", b_map_type.clone(), true)));
