...
LEGACY_CEILINGS: dict[str, int] = {
    ...
    "crates/iceberg/src/transaction/cherry_pick.rs": 2106,
    ...
    "crates/iceberg/src/transaction/replace_partitions.rs": 2800,
    ...
    "crates/iceberg/src/transaction/snapshot.rs": 3450,
