...
LEGACY_CEILINGS: dict[str, int] = {
    ...
    "crates/iceberg/src/maintenance/rewrite_data_files.rs": 2449,
    "crates/iceberg/src/maintenance/rewrite_position_delete_files_tests.rs": 4715,
    ...
    "crates/iceberg/src/transaction/replace_partitions.rs": 2784,
