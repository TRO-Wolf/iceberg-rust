...
LEGACY_CEILINGS: dict[str, int] = {
    ...
    "crates/iceberg/src/transaction/row_delta.rs": 6385,
    ...
    "crates/integrations/datafusion/src/physical_plan/delete.rs": 1700,
    ...
    "crates/integrations/datafusion/tests/integration_datafusion_test.rs": 6885,
