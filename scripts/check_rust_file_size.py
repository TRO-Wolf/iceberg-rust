...
LEGACY_CEILINGS: dict[str, int] = {
    ...
    "crates/iceberg/src/writer/base_writer/deletion_vector_writer.rs": 1426,
    ...
    "crates/integrations/datafusion/src/physical_plan/delete.rs": 2302,
    ...
    "crates/integrations/datafusion/src/table/mod.rs": 2337,
