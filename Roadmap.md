...
| F-14 | `MetadataLocation` next-pointer math for Hadoop-convention `vN.metadata.json` names, or a dated gap ruling | R167 | engine pin `call_register_table_of_hadoop_named_metadata_writes_name_the_convention` retargets to "the write succeeds", or cites the ruling |
