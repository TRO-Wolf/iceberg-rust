...
Agent instructions for this repository. Claude-specific intent, prohibitions, and the navigation
contract live in [CLAUDE.md](CLAUDE.md) (it points here for the crate-level engineering rules);
CLAUDE.md wins on any conflict. The rules below are the tool-agnostic engineering contract.
