...
echo "    The V3 leg: the same world upgraded to V3 reads identically before (ten legacy parquet"
echo "               position deletes, five per partition) and after (two Puffin deletion vectors) the conversion."
